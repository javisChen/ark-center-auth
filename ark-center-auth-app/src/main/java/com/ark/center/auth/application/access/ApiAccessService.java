...
import com.ark.center.auth.infra.authentication.api.ApiAccessAuthenticationToken;
...
public class ApiAccessService {
    ...
    public boolean authenticate(ApiAccessAuthenticateQuery request) throws AuthenticationException {
